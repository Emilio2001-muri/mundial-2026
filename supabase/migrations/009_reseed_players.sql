-- ================================================================
-- Migration 009: Reseed all 48×26 player squads
-- Deletes all players and re-inserts fresh so no player is missing.
-- Safe to run before tournament starts (no finished matches yet).
-- ================================================================

-- Step 1: Remove all players (cascades to scorer_predictions / lineups)
DELETE FROM public.players;

-- Step 2: Re-insert all 48 teams × 26 players
-- ═══════════════════════════════════════════════════════════════
-- GROUP A
-- ═══════════════════════════════════════════════════════════════
INSERT INTO public.players (team_id,name,position,shirt_number)
SELECT t.id,v.name,v.pos,v.num FROM public.teams t, (VALUES
...
(16,'Sultan Al-Brake','DF'),(17,'Ahmed Al-Ganehi','MF'),(18,'Assim Madibo','MF'),(19,'Almoez Ali','FW'),(20,'Ahmed Fathy','MF'),
(21,'Salah Zakaria','GK'),(22,'Mahmud Abunada','GK'),(23,'Issa Laye','DF'),(24,'Tahsin Jamshid','FW'),(25,'Ayoub Al-Oui','DF'),(26,'Mohamed Manai','FW')
...
(21,'Alexander Prass','MF'),(22,'Marco Friedl','DF'),(23,'Lukas Mühl','DF'),(24,'Paul Wanner','MF'),(25,'Michael Svoboda','DF'),(26,'Alessandro Schöpf','MF')
